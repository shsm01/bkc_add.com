...
$APPLICATION->SetTitle("Лицензии и дипломы");
?><?$APPLICATION->IncludeComponent("bitrix:catalog.sections.top", "licens_diplom", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"ELEMENT_COUNT" => "300",	// Максимальное количество элементов, выводимых в каждом разделе
