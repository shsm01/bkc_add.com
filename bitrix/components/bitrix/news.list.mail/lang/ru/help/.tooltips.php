...
$MESS["PREVENT_SEND_IF_NO_NEWS_TIP"] = "Если настройка установлена, то будут выбираться элементы, созданные с момента последней отправки периодического выпуска. Причем, если количество элементов меньше указанного в настройке количества, то выпуск не будет отправлен.";
$MESS["SENDER_CHAIN_ID_TIP"] = "Указывается код периодического выпуска Email-маркетинга, у которого будет браться дата последней отправки для поиска новых элементов с этой даты. Обычно значение этой настройки остается по-умолчанию.";
