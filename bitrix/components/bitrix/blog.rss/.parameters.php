...
$arComponentParameters = Array(
	...
	"PARAMETERS" => Array(
		...
		"PATH_TO_BLOG" => Array(
			"NAME" => GetMessage("BR_PATH_TO_BLOG"),
			"TYPE" => "STRING",
			"MULTIPLE" => "N",
			"DEFAULT" => "",
			"COLS" => 25,
		...
		"MODE" => Array(
			"NAME" => GetMessage("BR_MODE"),
			"TYPE" => "LIST",
			"MULTIPLE" => "N",
			"DEFAULT" => "={\$mode}",
			"ADDITIONAL_VALUES" => "N",
			"VALUES" => Array("P"=>GetMessage("BR_MODE_POST"), "C" => GetMessage("BR_MODE_COMMENT")),
			"COLS" => 25,
			"PARENT" => "ADDITIONAL_SETTINGS",
		),
