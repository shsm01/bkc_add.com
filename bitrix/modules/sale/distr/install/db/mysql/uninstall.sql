...
drop table if exists b_sale_delivery_rstr;
drop table if exists b_sale_bizval;
drop table if exists b_sale_bizval_code;
drop table if exists b_sale_bizval_group;
drop table if exists b_sale_bizval_parent;
drop table if exists b_sale_bizval_codeparent;
