...
//				}
//
//				if (!isset($bundleIndex[$parentBasketItem->getBasketCode()]))
//				{
//					$bundleIndex[$parentBasketItem->getBasketCode()] = array();
//				}
//				elseif (!in_array($basketItem->getBasketCode(), $bundleIndex[$parentBasketItem->getBasketCode()]))
//				{
//					$bundleIndex[$parentBasketItem->getBasketCode()][] = $basketItem->getBasketCode();
//				}
//			}
//			elseif ($basketItem->isBundleParent() && !isset($bundleIndex[$basketItem->getBasketCode()]))
//			{
//				$bundleIndex[$basketItem->getBasketCode()] = array();
//			}
//		}
