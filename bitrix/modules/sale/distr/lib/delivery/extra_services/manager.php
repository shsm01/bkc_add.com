...
class Manager
{
	...
	public function __construct($initParam, $values = array(), array $additionalParams = array())
	{
		$itemsParams = array();
		...
		foreach($itemsParams as $params)
			$this->addItem($params, isset($values[$params["ID"]]) ? $values[$params["ID"]] : null, $additionalParams);
	}
	...
	protected function addItem($params, $value = null, array $additionalParams = array())
	{
		...
		$item = new $params["CLASS_NAME"]($params["ID"], $params, $value, $additionalParams);
