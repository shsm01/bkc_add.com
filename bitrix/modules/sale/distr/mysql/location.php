...
class CSaleLocation extends CAllSaleLocation
{
	...
	*/
	...
	function AddCountry($arFields)
	{
		...
		if(self::isLocationProMigrated())
		{
			return parent::AddLocationUnattached('COUNTRY', $arFields);
		}
	...
	function AddCity($arFields)
	{
		...
		if(self::isLocationProMigrated())
		{
			return parent::AddLocationUnattached('CITY', $arFields);
		}
	...
	function AddRegion($arFields)
	{
		...
		if(self::isLocationProMigrated())
		{
			return parent::AddLocationUnattached('REGION', $arFields);
		}
