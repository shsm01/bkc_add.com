...
$MESS ['SPOD_SHOW_ORDER_BASKET'] = "Показывать состав заказа";
$MESS ['SPOD_SHOW_ORDER_BASE'] = "Показывать общие данные заказа";
$MESS ['SPOD_SHOW_ORDER_USER'] = "Показывать данные учетной записи";
$MESS ['SPOD_SHOW_ORDER_PARAMS'] = "Показывать параметры заказа";
$MESS ['SPOD_SHOW_ORDER_BUYER'] = "Показывать личные данные";
$MESS ['SPOD_SHOW_ORDER_DELIVERY'] = "Показывать данные для доставки";
$MESS ['SPOD_SHOW_ORDER_PAYMENT'] = "Показывать параметры доставки и оплаты";
$MESS ['SPOD_SHOW_ORDER_SUM'] = "Показывать итоговую сумму";

$MESS["SPOD_COLUMNS_LIST"] = "Выводимые колонки состава заказа";
$MESS["SPOD_BNAME"] = "Название товара";
$MESS["SPOD_BPROPS"] = "Свойства товара";
$MESS["SPOD_BPRICE"] = "Цена";
$MESS["SPOD_BSUM"] = "Сумма";
$MESS["SPOD_BTYPE"] = "Тип цены";
$MESS["SPOD_BQUANTITY"] = "Количество";
$MESS["SPOD_BDELETE"] = "Удалить";
$MESS["SPOD_BDELAY"] = "Отложить";
$MESS["SPOD_BWEIGHT"] = "Вес";
$MESS["SPOD_BDISCOUNT"] = "Скидка";
