...
$arTemplateParameters = array(
	...
	"DISPLAY_IMG_MEDIUM_WIDTH" => Array(
		"NAME" => GetMessage("T_IBLOCK_DESC_IMG_MEDIUM_WIDTH"),
		"TYPE" => "TEXT",
		"DEFAULT" => "136",
	),
	"DISPLAY_IMG_MEDIUM_HEIGHT" => Array(
		"NAME" => GetMessage("T_IBLOCK_DESC_IMG_MEDIUM_HEIGHT"),
		"TYPE" => "TEXT",
		"DEFAULT" => "101",
	),
	"DISPLAY_IMG_DETAIL_WIDTH" => Array(
		"NAME" => GetMessage("T_IBLOCK_DESC_IMG_DETAIL_WIDTH"),
		"TYPE" => "TEXT",
		"DEFAULT" => "298",
	),
	"DISPLAY_IMG_DETAIL_HEIGHT" => Array(
		"NAME" => GetMessage("T_IBLOCK_DESC_IMG_DETAIL_HEIGHT"),
		"TYPE" => "TEXT",
		"DEFAULT" => "221",
	),
	"USE_SHARE" => Array(
