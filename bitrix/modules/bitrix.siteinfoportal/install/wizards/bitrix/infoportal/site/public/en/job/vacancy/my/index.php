...
$APPLICATION->SetTitle("Post a Vacancy");
?><?$APPLICATION->IncludeComponent("bitrix:iblock.element.add", ".default", array(
	"NAV_ON_PAGE" => "10",
	"USE_CAPTCHA" => "Y",
	"USER_MESSAGE_ADD" => "You vacancy has been added",
	"USER_MESSAGE_EDIT" => "You vacancy has been saved",
	...
	"CUSTOM_TITLE_DETAIL_TEXT" => "Position Description",
	"CUSTOM_TITLE_DETAIL_PICTURE" => "",
	"SEND_EMAIL" => "Y",
	"EMAIL_TO" => "#EMAIL_TO#",
	"SUBJECT" => "A vacancy has been submitted",
