...
$MESS['SECURITY_USER_RECOVERY_CODES_OTP_NOT_ACTIVE'] = "Двухэтапная авторизация не используется";
$MESS['SECURITY_USER_RECOVERY_CODES_DISABLED'] = "Резервные коды не используются";