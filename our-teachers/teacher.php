...
if($prep["DETAIL_PICTURE"]["HEIGHT"]<=170 && $prep["DETAIL_PICTURE"]["HEIGHT"]<$h){
	...
	?>
        ...
        <div class="window-teacher-text">
			...
			<?endif;?>
			<?if (is_array($prep['PROPERTIES']['school']['VALUE']) && count($prep['PROPERTIES']['school']['VALUE'])>0):?>
                <div class="teacher-details-row">
			...
			<?endif;?>
			<?if (is_array($prep['PROPERTIES']['curs']['VALUE']) && count($prep['PROPERTIES']['curs']['VALUE'])>0):?>
                <div class="teacher-details-row">
			...
			<?if (is_array($prep['PROPERTIES']['links']['~VALUE']) && count($prep['PROPERTIES']['links']['~VALUE'])>0):?>
