                        ...
                        <div class="school-news-header">
                            <h2>Новости и акции школы</h2>
                            <a href="/schools/<?=$_REQUEST['SECTION_CODE']?>/news/" class="school-news-all">Все новости</a>
                        </div>
                        <!-- school news header END -->
...
$arFilter = Array('IBLOCK_ID'=>11, 'ACTIVE'=>'Y', 'CODE'=>$_REQUEST['SECTION_CODE']);
  ...
  $sec=$db_list->GetNext();
$arrFilter=Array('PROPERTY_school'=>$sec['ID']);
$APPLICATION->IncludeComponent("bitrix:news.list", "school_news_bottom", Array(
