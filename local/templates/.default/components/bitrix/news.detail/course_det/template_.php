...
?>
                        ...
                        <div class="course-price">
                            ...
                            <div class="course-price-link"><a href="/local/windows/order_course.php?id=<?=$arResult['ID']?>" class="btn window-link">Заказать курс</a></div>
                        </div>
...
$c=0;
while($rew=$rew_res->GetNextElement())
{
	if ($c==0){
	print('
						<h2>Отзывы</h2>
