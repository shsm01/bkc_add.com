...
$arSection["PICTURE"]=CFile::ResizeImageGet($arSection["PICTURE"],array("width" => 270, "height" => 180),BX_RESIZE_IMAGE_EXACT,true);
...
?>
                            <div class="photo-galleries-item">
                                <a href="<?=$arSection['SECTION_PAGE_URL']?>">
                                   ...
                                   <? if($arSection['DESCRIPTION']) {?><div class="photo-galleries-item-anonce"><?=$arSection['DESCRIPTION']?></div><?}?>
