	...
	?>
		...
		<?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arItem["PREVIEW_PICTURE"])):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<div class="news-item-preview"><a href="/schools/<?=$_REQUEST['SECTION_CODE']?>/news/<?=$arItem["CODE"]?>/"><img
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
                                    <div class="news-item-title"><a href="/schools/<?=$_REQUEST['SECTION_CODE']?>/news/<?=$arItem["CODE"]?>/"><?echo $arItem["NAME"]?></a></div>
			<?else:?>
